...
// ---- Staff Names (Nghệ nhân) ----
export const mockStaffNames: StaffName[] = [
  { id: 's1', name: 'Anh Tới', avatar_color: '#C8621A', is_active: true, created_at: '2026-01-01T00:00:00Z' },
  { id: 's2', name: 'Chị Liên', avatar_color: '#7C3AED', is_active: true, created_at: '2026-01-01T00:00:00Z' },
];
...
export const mockOrderUpdates: OrderUpdate[] = [
  { id: 'u1', order_id: 'o1', milestone_name: 'Nhào đất', note: 'Đất đã nhào xong, để ủ qua đêm', status_after: 'crafting', created_by_type: 'viewer', created_by_admin_id: null, created_by_name: 'Anh Tới', created_at: '2026-05-10T08:30:00Z', images: mockImages.filter(i => i.update_id === 'u1') },
  { id: 'u2', order_id: 'o1', milestone_name: 'Tạo hình', note: 'Đã tạo hình trên bàn xoay, đang chỉnh chi tiết', status_after: 'crafting', created_by_type: 'viewer', created_by_admin_id: null, created_by_name: 'Anh Tới', created_at: '2026-05-12T10:15:00Z', images: mockImages.filter(i => i.update_id === 'u2') },
  { id: 'u3', order_id: 'o1', milestone_name: 'Phơi khô', note: 'Sản phẩm đã phơi khô 3 ngày', status_after: 'drying', created_by_type: 'viewer', created_by_admin_id: null, created_by_name: 'Chị Liên', created_at: '2026-05-15T14:00:00Z', images: mockImages.filter(i => i.update_id === 'u3') },
  { id: 'u4', order_id: 'o2', milestone_name: 'Nhào đất', note: 'Bắt đầu làm set bát', status_after: 'crafting', created_by_type: 'viewer', created_by_admin_id: null, created_by_name: 'Chị Liên', created_at: '2026-05-18T09:00:00Z', images: mockImages.filter(i => i.update_id === 'u4') },
  { id: 'u5', order_id: 'o3', milestone_name: 'Tạo hình', note: 'Bình hoa đã tạo hình xong', status_after: 'crafting', created_by_type: 'admin', created_by_admin_id: 'admin1', created_by_name: 'Admin', created_at: '2026-05-08T16:00:00Z', images: [] },
  { id: 'u6', order_id: 'o3', milestone_name: 'Phơi khô', note: null, status_after: 'drying', created_by_type: 'viewer', created_by_admin_id: null, created_by_name: 'Anh Tới', created_at: '2026-05-11T09:00:00Z', images: [] },
  { id: 'u7', order_id: 'o3', milestone_name: 'Nung lần 1', note: 'Nung ở 1000°C trong 8 tiếng', status_after: 'firing', created_by_type: 'viewer', created_by_admin_id: null, created_by_name: 'Anh Tới', created_at: '2026-05-14T06:00:00Z', images: [] },
  { id: 'u8', order_id: 'o3', milestone_name: 'Hỏng - Vỡ', note: 'Bình bị nứt khi nung', status_after: 'broken', created_by_type: 'viewer', created_by_admin_id: null, created_by_name: 'Chị Liên', created_at: '2026-05-16T10:00:00Z', images: [] },
  { id: 'u9', order_id: 'o3', milestone_name: 'Làm lại', note: 'Tạo hình lại bình hoa mới', status_after: 'redoing', created_by_type: 'viewer', created_by_admin_id: null, created_by_name: 'Anh Tới', created_at: '2026-05-18T06:00:00Z', images: [] },
  { id: 'u10', order_id: 'o3', milestone_name: 'Nung lại', note: 'Nung lại sản phẩm mới', status_after: 'refiring', created_by_type: 'admin', created_by_admin_id: 'admin1', created_by_name: 'Admin', created_at: '2026-05-20T14:00:00Z', images: [] },
];

// ---- Orders ----
export const mockOrders: Order[] = [
  { id: 'o1', order_code: 'DH-20260508-001', customer_id: 'c1', product_name: 'Ấm trà 200ml', product_id: 'p1', quantity: 2, custom_requirements: 'Khách muốn quai cao hơn bình thường, men nâu đất', reference_images: [], reference_images_notes: [], status: 'drying', start_date: '2026-05-08', due_date: '2026-05-25', price: 700000, deposit: 350000, internal_note: 'Khách quen, ưu tiên làm trước', created_at: '2026-05-08T00:00:00Z', updated_at: '2026-05-15T14:00:00Z' },
  { id: 'o2', order_code: 'DH-20260510-002', customer_id: 'c2', product_name: 'Bát ăn cơm set 10', product_id: 'p2', quantity: 10, custom_requirements: null, reference_images: [], reference_images_notes: [], status: 'crafting', start_date: '2026-05-10', due_date: '2026-05-28', price: 850000, deposit: 400000, internal_note: null, created_at: '2026-05-10T00:00:00Z', updated_at: '2026-05-18T09:00:00Z' },
  { id: 'o3', order_code: 'DH-20260505-003', customer_id: 'c3', product_name: 'Bình hoa lớn', product_id: 'p3', quantity: 1, custom_requirements: 'Men lam xanh, cao 45cm', reference_images: [], reference_images_notes: [], status: 'refiring', start_date: '2026-05-05', due_date: '2026-05-20', price: 750000, deposit: 750000, internal_note: null, created_at: '2026-05-05T00:00:00Z', updated_at: '2026-05-20T14:00:00Z' },
  { id: 'o4', order_code: 'DH-20260515-004', customer_id: 'c4', product_name: 'Đĩa trang trí', product_id: 'p4', quantity: 5, custom_requirements: 'Men rạn, đường kính 25cm', reference_images: [], reference_images_notes: [], status: 'not_started', start_date: '2026-05-15', due_date: '2026-06-01', price: 1000000, deposit: 500000, internal_note: 'Chờ đất về', created_at: '2026-05-15T00:00:00Z', updated_at: '2026-05-15T00:00:00Z' },
  { id: 'o5', order_code: 'DH-20260518-005', customer_id: 'c5', product_name: 'Ly uống trà set 6', product_id: 'p5', quantity: 20, custom_requirements: 'Logo công ty khắc chìm mặt ngoài', reference_images: [], reference_images_notes: [], status: 'not_started', start_date: '2026-05-18', due_date: '2026-06-10', price: 3600000, deposit: 1800000, internal_note: 'Đơn sỉ lớn', created_at: '2026-05-18T00:00:00Z', updated_at: '2026-05-18T00:00:00Z' },
  { id: 'o6', order_code: 'DH-20260501-006', customer_id: 'c1', product_name: 'Bình hoa nhỏ', product_id: null, quantity: 3, custom_requirements: 'Men trắng sữa', reference_images: [], reference_images_notes: [], status: 'firing', start_date: '2026-05-01', due_date: '2026-05-18', price: 600000, deposit: 300000, internal_note: null, created_at: '2026-05-01T00:00:00Z', updated_at: '2026-05-16T00:00:00Z' },
  { id: 'o7', order_code: 'DH-20260520-007', customer_id: 'c2', product_name: 'Ấm trà set lớn', product_id: 'p1', quantity: 1, custom_requirements: 'Ấm + 6 ly + khay gỗ', reference_images: [], reference_images_notes: [], status: 'broken', start_date: '2026-05-20', due_date: '2026-06-15', price: 1200000, deposit: 600000, internal_note: null, created_at: '2026-05-20T00:00:00Z', updated_at: '2026-05-20T00:00:00Z' },
  { id: 'o8', order_code: 'DH-20260503-008', customer_id: 'c3', product_name: 'Bát decor', product_id: null, quantity: 8, custom_requirements: 'Vẽ tay hoa sen', reference_images: [], reference_images_notes: [], status: 'redoing', start_date: '2026-05-03', due_date: '2026-05-15', price: 960000, deposit: 960000, internal_note: null, created_at: '2026-05-03T00:00:00Z', updated_at: '2026-05-14T00:00:00Z' },
];
